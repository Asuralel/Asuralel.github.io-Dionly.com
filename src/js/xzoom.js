...
XZoom.prototype = {
	...
	_init:function(options){
		...
		this.ele.onmousemove = (e)=>{
			var left = e.pageX - this.ele.offsetLeft - this.zoom.offsetWidth/2;
			var top = e.pageY - this.ele.offsetTop - this.zoom.offsetHeight/2;
	...
	show:function(){
		...
		$('#ui-product-zoom').append(this.big);
